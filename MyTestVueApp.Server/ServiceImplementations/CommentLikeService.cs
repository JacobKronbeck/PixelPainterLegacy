    ...
    public class CommentLikeService : ICommentLikeService
    {
        ...
        public async Task<int> InsertCommentLike(Artist artist, int commentId)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                var checkDupQuery = "SELECT COUNT(*)::int FROM CommentLikes WHERE ArtistID = @ArtistId AND CommentID = @CommentId";
        ...
        public async Task<bool> IsCommentLiked(Artist artist, int commentId)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                string likedQuery = "SELECT COUNT(*)::int FROM CommentLikes WHERE ArtistId = @ArtistId AND CommentID = @CommentId";
